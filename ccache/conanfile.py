...
class CcacheConan(ConanFile):
    ...
    name = 'ccache'
    version = '4.8.3'
    requires = ('helpers/0.4@matt/stable')
    ...
    def source(self):
        ...
        if copyFromCache(archive_file):
            ...
            try:
                ...
                self.output.warning('Received exception while downloding ccache archive.  Attempting to clone from source. Exception = %s'%e)
